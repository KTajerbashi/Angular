...
public static class StringExtensions
{
    ...
    public static byte[] ToByteArray(this string input) => System.Text.Encoding.UTF8.GetBytes(input);
    public static string FromByteArray(this byte[] input) => System.Text.Encoding.UTF8.GetString(input);
