...
namespace AngularApp.Infra.Data.Migrations
{
    ...
    [Migration("20260128224459_Add_UR_U_R")]
    partial class Add_UR_U_R
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AngularApp.Core.Domain.Entities.Security.User.UserRoleEntity", b =>
                {
                    b.HasOne("AngularApp.Core.Domain.Entities.Security.Role.RoleEntity", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AngularApp.Core.Domain.Entities.Security.User.UserEntity", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
